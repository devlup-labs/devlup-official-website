...
export function BlogView() {
  ...
  if (loading) return (
    <div className={`h-screen flex items-center justify-center transition-all duration-500 ${isDarkMode ? 'text-white' : 'text-black'} bg-cover bg-fixed bg-center`} style={{ backgroundImage: isDarkMode ? "url('/bg_dark.jpeg')" : "url('/bg_light.jpeg')" }}>Loading...</div>
  );

  return (
    <div className={`min-h-screen flex flex-col transition-all duration-500 ${isDarkMode ? 'text-white' : 'text-black'} bg-cover bg-fixed bg-center`} style={{ backgroundImage: isDarkMode ? "url('/bg_dark.jpeg')" : "url('/bg_light.jpeg')" }}>
